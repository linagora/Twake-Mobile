...
class Message extends BaseModel {
  ...
  List<MessageLink>? _messageLinks;

  List<MessageLink>? get messageLinks => _messageLinks;

  bool get isMessageHasLinks =>
      _messageLinks != null && _messageLinks!.isNotEmpty;
  ...
  Message({
    ...
    List<MessageLink>? messageLinks = const <MessageLink>[],
  }) {
    this._lastReplies = lastReplies;
    this._messageLinks = messageLinks;
  }
