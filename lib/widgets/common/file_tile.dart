...
import 'package:twake/blocs/cache_files_cubit/cache_files_cubit.dart';
...
>>>>>>> 14ac9389 (fix #1135 sender chat text color inside file)
>>>>>>> 2b0c987b (fix language when logout)
>>>>>>> 83a0ab8a (fix #1135 sender chat text color inside file)

  @override
  Widget build(BuildContext context) {
    Get.find<CacheFilesCubit>().findCacheFile(fileId: fileId);
    File? cacheFile;
    final cacheFileState = Get.find<CacheFilesCubit>().state;
        ...
        ? FutureBuilder(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                ...
                Get.find<CacheFilesCubit>().setFile(file: file);
